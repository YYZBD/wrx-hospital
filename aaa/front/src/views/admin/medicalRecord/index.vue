<script setup>
  ...
  import {GetPage, Delete} from "^/admin/medicalRecord.js";
    ...
    <el-table :data="data.pageData" border style="width: 100%" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55"></el-table-column>
                  ...
                  <el-table-column prop="id" label=""/>
                        <el-table-column prop="sn" label="就诊编号"/>
                        <el-table-column prop="userId" label="用户ID"/>
                        <el-table-column prop="doctorId" label="医生ID"/>
                        <el-table-column prop="bookingId" label="预约ID"/>
                        <el-table-column prop="bookingSn" label=""/>
                        ...
                        <el-table-column prop="recordTime" label="就诊日期"/>
